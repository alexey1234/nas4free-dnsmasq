...
if ( ! is_file ( "/usr/local/www/ext/dnsmasq/extensions_dnsmasq_log.php") ) copy ($config['dnsmasq']['rootfolder']."www/extensions_dnsmasq_conf.php","/usr/local/www/ext/dnsmasq/extensions_dnsmasq_log.php");else {}
if ( ! is_file ( "/usr/local/www/ext/dnsmasq/extensions_dnsmasq_clients.php") ) copy ($config['dnsmasq']['rootfolder']."www/extensions_dnsmasq_conf.php","/usr/local/www/ext/dnsmasq/extensions_dnsmasq_clients.php");else {}
if ( ! is_file ( "/usr/local/www/ext/dnsmasq/extensions_dnsmasq_check.php") ) copy ($config['dnsmasq']['rootfolder']."www/extensions_dnsmasq_conf.php","/usr/local/www/ext/dnsmasq/extensions_dnsmasq_check.php");else {}
if ( ! is_file ( "/usr/local/www/ext/dnsmasq/warn.png") ) copy ($config['dnsmasq']['rootfolder']."www/extensions_dnsmasq_conf.php","/usr/local/www/ext/dnsmasq/warn.png");else {}
if ( ! is_file ( "/usr/local/www/ext/dnsmasq/gradient_listhdr1_good.png") ) copy ($config['dnsmasq']['rootfolder']."www/extensions_dnsmasq_conf.php","/usr/local/www/ext/dnsmasq/gradient_listhdr1_good.png");else {}
if ( ! is_file ( "/usr/local/www/ext/dnsmasq/gradient_listhdr1_bad.png") ) copy ($config['dnsmasq']['rootfolder']."www/extensions_dnsmasq_conf.php","/usr/local/www/ext/dnsmasq/gradient_listhdr1_bad.png");else {}
