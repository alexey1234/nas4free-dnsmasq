			...
			<table width="100%" border="0" cellpadding="5" cellspacing="0">
				...
				<tr>
				  <?php if (is_file( "/var/db/dnsmasq.leases")) $leasefile = file("/var/db/dnsmasq.leases");
					...
					for ($i=0;  count ( $leasefile ) -1; $i++) {
					value[] = explode (" ",$leasefile[$i] ;
					echo "<td width="33%" class="listhdrlr">&nbsp;".value[1]."</td>";
					echo "<td width="33%" class="listhdrlr">&nbsp;".value[2]."</td>";
					echo "<td width="33%" class="listhdrlr">&nbsp;".value[3]."</td>";
}
}
?>
			</tr>
